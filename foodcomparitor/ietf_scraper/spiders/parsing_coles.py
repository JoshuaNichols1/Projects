...
class IetfSpider(scrapy.Spider):
    ...
    def __init__(self):
        self.results = []
        self.count = 0
        self.max = len(temp_urls[0:200]) - 1
    ...
    def parse(self, response):
        def update_nutrition():
            ...
            kj = response.xpath(
                "/html/body/div[1]/div[1]/div[1]/div/div[5]/ul/li[1]/div/div/table/tbody/tr[2]/td[1]/div/text()"
            ).get()
            protein = response.xpath(
                "/html/body/div[1]/div[1]/div[1]/div/div[5]/ul/li[1]/div/div/table/tbody/tr[3]/td[1]/div/text()"
            ).get()
            total_fat = response.xpath(
                "/html/body/div[1]/div[1]/div[1]/div/div[5]/ul/li[1]/div/div/table/tbody/tr[4]/td[1]/div/text()"
            ).get()
            saturated_fat = response.xpath(
                "/html/body/div[1]/div[1]/div[1]/div/div[5]/ul/li[1]/div/div/table/tbody/tr[5]/td[1]/div/text()"
            ).get()
            carbohydrates = response.xpath(
                "/html/body/div[1]/div[1]/div[1]/div/div[5]/ul/li[1]/div/div/table/tbody/tr[6]/td[1]/div/text()"
            ).get()
            sugars = response.xpath(
                "/html/body/div[1]/div[1]/div[1]/div/div[5]/ul/li[1]/div/div/table/tbody/tr[7]/td[1]/div/text()"
            ).get()
            sodium = response.xpath(
                "/html/body/div[1]/div[1]/div[1]/div/div[5]/ul/li[1]/div/div/table/tbody/tr[8]/td[1]/div/text()"
            ).get()
